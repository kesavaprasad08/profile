    ...
    <div className="flex flex-col items-center  p-5 pt-32" id="myProjects">
      ...
      <div className="w-11/12 md:w-9/12 mt-5 bg-navGreen rounded shadow p-8 flex flex-col lg:flex-row flex-wrap justify-between">
        ...
        />
          ...
          <div className="mt-2">
          <a href="https://mail-box-client-3bc7d.web.app/mailbox" target="_blank" rel="noopener noreferrer" className="lg:p-2">
              <button className="bg-green-500 p-2 hover:bg-green-300 rounded">
                Live App
              </button>
            </a>
            <a href="https://github.com/kesavaprasad08/mail-box-client" target="_blank" rel="noopener noreferrer"  className="lg:p-2 pl-2">
              <button className="bg-green-500 p-2 hover:bg-green-300 rounded">
                Github Repository
              </button>
            </a>
